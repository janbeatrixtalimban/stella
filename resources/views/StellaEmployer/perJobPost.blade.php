                    ...
                    <div class="side-navbar" style="color:black; border-right:black;">
                        ...
                        <ul class="nav flex-column">
                          ...
                          @foreach($projects as $project)
                            <li class="nav-item">
                                <a class="nav-link" value="{{ $project->projectID }}" href="">{{ $project->prjTitle }}</a>
                            </li>
                          @endforeach<br><br>
                        </ul>
                    </div>
                                                ...
                                                <!--Buttons with icons -->
                                                    <form class="" action="/employer/accept" method="post">
                                                      {{ csrf_field() }}
                                                        ...
                                                        <button type="submit" name="button" rel="tooltip" title="Accept" class="btn btn-success btn-round"><i class="now-ui-icons ui-1_check"></i></button>
                                                        <button type="submit" name="button" rel="tooltip" title="Reject" class="btn btn-maroon btn-round"><i class="now-ui-icons ui-1_simple-remove"></i></button>
                                                    </form>
                                                </div>

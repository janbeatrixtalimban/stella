...
<title>@yield('pageTitle') View Hired Models </title>
...
<body class="landing-page sidebar-collapse" data-spy="scroll">
                      ...
                      <li class="nav-item">
                          <a class="nav-link dropdown-toggle" href="#pablo" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <p>
                                ...
                                <span class="d-lg-none d-md-block">   View Hired Models</span>
                              </p>
                            </a>
  ...
  <div class="wrapper">
            ...
            <div class="row">
                <div class="col-sm-2"><!--side navbar-->
                    <div class="side-navbar" style="color:black; border-right:black;">
                        <h4 class="text-center">&nbsp;&nbsp;View Hired Models</h4>
                        <br>
            	...
            	<div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="column">
                            <h5 style="color:#1b1b1b;">{{ $detail->prjTitle }}</h5>
                                ...
                                <div id="model" class="card text-center">
                                    <div class="card-body" style="color:#1b1b1b;" style="width:100%;">
                                        <h5 class="card-title">{{ $detail->firstName }} {{ $detail->lastName }}</h5>
                                            ...
                                            <a data-toggle="modal" data-target="#details{{ $detail->hireID }}" style="color:white;" class="btn btn-info btn-round"><i class="now-ui-icons design_bullet-list-67"></i>&nbsp;View Details</a>
                                    </div>
		...
		<div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-3"></div>
                            <div class="col-lg-9">
                                <h2 class="text-center" style='color:grey;'> No currently hired models to show</h2>
                            </div>
                    </div>
                </div>                                    
                    @else
    ...
    @foreach ($details as $detail)
            ...
            <div id="details{{$detail->hireID}}" class="modal fade" style="padding-top: 120px;" tabindex="-1" role="dialog">
			...
			<ul>
                          		<li>
                              		<h0>Project Hired: <b>{{ $detail->prjTitle }}<b></h0>
                          		</li>
                          		<li>
                             		<h0>Project Date/s: <b>{{ $detail->jobDate }} to {{ $detail->jobEnd }}<b></h0>
                         		</li>
				...
				<li>
                              		<h0>Agreed Talent fee: <b>P{{ $detail->haggleAmount }}.00<b> </h0>
                          		</li>
				@elseif( $detail->haggleStatus == 2)
				<li>
                              		<h0>Agreed Talent fee: <b>P{{ $detail->talentFee }}.00<b> </h0>
                          		</li>
				@else
				@endif
                      	</ul>

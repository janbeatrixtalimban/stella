      ...
      <div class="container-fluid">
		...
		<div class="col-sm-2"><!--side navbar-->
                    <div class="side-navbar" style="color:black; border-right:black;">
                        <h4 class="text-center">&nbsp;&nbsp;View Accepted Offers</h4>
                        <br>
...
@else 
	...
	<div class="row">
	    ...
	    <div class="col-lg-8">
            	<h2 class="text-center" style='color:grey; padding-top:40%;'> No currently accepted offers</h2>
	    <div class="col-lg-2"></div>
	    </div>
	</div>
    </div>   

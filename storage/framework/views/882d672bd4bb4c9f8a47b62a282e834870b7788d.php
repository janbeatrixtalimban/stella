...
<body class="landing-page sidebar-collapse" data-spy="scroll">
            ...
            <nav class="navbar navbar-expand navbar-dark bg-black flex-column flex-md-row bd-navbar">
                ...
                <div class="navbar-translate">
                    <a class="navbar-brand" rel="tooltip" title="Click to go Home" href="<?php echo e(url('/employerfeed')); ?>" data-placement="bottom">
                ...
                <div class="col-sm-2"><!--side navbar-->
                    <div class="side-navbar" style="color:black;">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(url('/editProfile')); ?>">Edit Profile</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="col-sm-4">
                        <div class="cointainer" style="color:black;">
                                <div class="card card-plain">
                                    <form method="POST" action="<?php echo e(url('/SaveEditEmp/'.Auth::user()->userID)); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="contactNo" value="<?php echo e(Auth::user()->contactNo); ?>" name="contactNo" >
                                        </div>
                                        <div class="form-group">

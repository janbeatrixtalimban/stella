...
<div class="main-panel">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td class="table-text">
                                                        <div class="thumbnail"> 
                                                            <img class="img-responsive portrait" alt=""  width="100px" src="/uploads/<?php echo e($detail->image); ?>" alt="Image"/>
                                                            </div>
                                                    </td>
                                                    <td class="table-text">
                                                        <div><?php echo e($detail->reason); ?></div>
                                                    </td>
                                                    <td class="table-text">
                                                            <div><?php echo e($detail->firstName); ?> <?php echo e($detail->lastName); ?></div>
                                                        </td>
                                                    <td class="table-text">
                                                    <?php if($detail->display == 'none'): ?>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                              <button data-toggle="modal" data-target="#archive<?php echo e($detail->imageID); ?>" type="submit" name="button" class="btn btn-round btn-sm btn-info">Archive</button>&nbsp;
                                                              |&nbsp;<a data-toggle="modal" data-target="#details<?php echo e($detail->imageID); ?> " style="color:blue; padding-top:3px;">View</a>
                                                        </div>
                                                    </td>
                                                </tr>
     ...
     <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div id="details<?php echo e($detail->imageID); ?>" class="modal fade" tabindex="-1" role="dialog">
                  ...
                  <!-- Modal content-->
                      <div class="modal-content" style="color:black;">
                          ...
                          <div class="modal-body">
                            ...
                            <img class="img-responsive portrait" alt="" src="/uploads/<?php echo e($detail->image); ?>" alt="Image"/>
      ...
      <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <!-- View job Post details -->
            <div id="archive<?php echo e($detail->imageID); ?>" class="modal fade" style="padding-top: 130px;" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                  ...
                  <!-- Modal content-->
                      <div class="modal-content" style="color:black;">
                          ...
                          <div class="modal-body">
                              ...
                              <h5>Are you sure you want to archive <?php echo e($detail->firstName); ?> <?php echo e($detail->lastName); ?>'s photo?</h5>
                          ...
                          <div class="modal-footer">
                            <div class="container text-center">
                              <form class="" action="/admin/archiveImage" method="post">
                                ...
                                <input style="hidden" type="hidden" name="imageID" id="imageID" value="<?php echo e($detail->imageID); ?>" readonly>

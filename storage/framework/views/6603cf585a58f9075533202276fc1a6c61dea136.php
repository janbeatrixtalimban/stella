                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="table-text">
                                                        <div><?php echo e($details->prjTitle); ?></div>
                                                    </td>
                                                    <td class="table-text">
                                                            <div><?php echo e($details->firstName); ?> <?php echo e($details->lastName); ?></div>
                                                        </td>
                                                    <td class="table-text">
                                                        <div><?php echo e($details->hidden); ?></div>
                                                    </td>
                                                    <td class="table-text">
                                                    ...
                                                    <td>
                                                        <form class="" action="/admin/archiveJobPost" method="post">
                                                          ...
                                                          <input style="hidden" type="hidden" name="projectID" id="projectID" value="<?php echo e($details->projectID); ?>" readonly>
